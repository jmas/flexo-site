...
<html>
	<head>
		...
		<title>Темы панели управления | Flexo CMS — open-souce GPL v3 система управления сайтом на PHP с БД MySQL или SQLite. Простая, расширяемая, небольшой размер. Система управления для сайта-визитки, портфолио, корпоративного сайта.</title>
			...
			<div id="middler">
				<aside id="sidebar">
						...
						<ul>
														...
														<li><a href="http://flexo.up.dn.ua/расширения/темы-админ-раздела.html"  class="current">Темы панели управления</a>																<ul>
																		<li><a href="http://flexo.up.dn.ua/расширения/темы-админ-раздела/тема-special.html" >Тема Special</a></li>
																	</ul>
															</li>
													</ul>
					</nav>
...
<span class="breadcrumb-current">Темы панели управления</span></div>
					
					<h1>Темы панели управления</h1>
					
					<ul id="gallery" class="tile-list">
			<li>
		<a href="http://flexo.up.dn.ua/расширения/темы-админ-раздела/тема-special.html">
			<img src="http://flexo.up.dn.ua/public/page_images/100x100-preview.png" width="100" height="100" alt="Тема Special" />
			<span>Тема Special</span>
		</a>
	</li>
	</ul>					
										<div id="disqus">
