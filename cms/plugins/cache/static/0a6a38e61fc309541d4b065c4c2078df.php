...
<html>
	<head>
		...
		<title>Captcha | Flexo CMS — open-souce GPL v3 система управления сайтом на PHP с БД MySQL или SQLite. Простая, расширяемая, небольшой размер. Система управления для сайта-визитки, портфолио, корпоративного сайта.</title>
				...
				<aside id="sidebar">
						...
						<ul>
														<li><a href="http://flexo.up.dn.ua/расширения/плагины.html"  class="current">Плагины</a>																<ul>
																		...
																		<li><a href="http://flexo.up.dn.ua/расширения/плагины/captcha.html"  class="current">Captcha</a></li>
...
<span class="breadcrumb-current">Captcha</span></div>
					
					<h1>Captcha</h1>
					
					<div>
<p>Плагин, который позволяет повысить безопасность форм, в частности формы входа в панель управления. В будущем будет использоваться в фронт-энд плагинах. Пример работы можно увидеть на <a href="/admin/">странице логина</a>.</p>
<p>Скачать плагин:&nbsp;<img src="/public/images/file-zip.png" alt="" />&nbsp;<a href="/public/files/plugins/captcha-1.0.0.zip">Captcha 1.0.0</a></p>
