...
<html>
	<head>
		...
		<title>Page images | Flexo CMS — open-souce GPL v3 система управления сайтом на PHP с БД MySQL или SQLite. Простая, расширяемая, небольшой размер. Система управления для сайта-визитки, портфолио, корпоративного сайта.</title>
				...
				<aside id="sidebar">
						...
						<ul>
														<li><a href="http://flexo.up.dn.ua/расширения/плагины.html"  class="current">Плагины</a>																<ul>
																		...
																		<li><a href="http://flexo.up.dn.ua/расширения/плагины/page-images.html"  class="current">Page images</a></li>
...
<span class="breadcrumb-current">Page images</span></div>
					
					<h1>Page images</h1>
					
					<p>Плагин позволяет прикреплять изображения к страницам и получать доступ к ним, через объект страницы.</p>
<p><img src="/public/images/plugins/page_images_1.1.0_preview.jpg" alt="" /></p>
<p>Скачать плагин:&nbsp;<img src="/public/images/file-zip.png" alt="" />&nbsp;<a href="/public/files/page_images_1.1.0.zip">Page images 1.1.0</a></p>
...
<p>1.1.0</p>
<p>* Добавление описаний к изображениям</p>
<p>* Сортировка изображений</p>
<p>1.0.0</p>
<p>Первый релиз</p>
<p>&nbsp;</p>					
										<div id="disqus">
