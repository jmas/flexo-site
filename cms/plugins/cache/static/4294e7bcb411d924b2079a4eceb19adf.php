...
<html>
	<head>
		...
		<title>Page Scheduler | Flexo CMS — open-souce GPL v3 система управления сайтом на PHP с БД MySQL или SQLite. Простая, расширяемая, небольшой размер. Система управления для сайта-визитки, портфолио, корпоративного сайта.</title>
				...
				<aside id="sidebar">
						...
						<ul>
														<li><a href="http://flexo.up.dn.ua/расширения/плагины.html"  class="current">Плагины</a>																<ul>
																		<li><a href="http://flexo.up.dn.ua/расширения/плагины/page-scheduler.html"  class="current">Page Scheduler</a></li>
																		...
																		<li><a href="http://flexo.up.dn.ua/расширения/плагины/slug-translit.html" >Slug translit</a></li>
...
<span class="breadcrumb-current">Page Scheduler</span></div>
					
					<h1>Page Scheduler</h1>
					
					<p>Плагин отображает календарь (по месяцам, по неделям, по дням) на который нанесены названия страниц в виде событий, при клике на событие - открывается страница редактирования публикации.</p>
<p>Данный плагин поможет отследить запланированные публикации.</p>
<p>Скриншоты:</p>
<ul>
<li><a href="http://www.diigo.com/item/image/30nlq/1jnb">Скриншот 1 (вид "Месяц")</a></li>
<li><a href="http://www.diigo.com/item/image/30nlq/8nsu">Скриншот 2 (вид "Неделя")</a></li>
<li><a href="http://www.diigo.com/item/image/30nlq/4spg">Скриншот 3 (вид "День")</a></li>
</ul>
<p>Скачать плагин:&nbsp;<img src="/public/images/file-zip.png" alt="" />&nbsp;<a href="/public/files/plugins/pages_scheduler_1.1.1.zip">Pages Scheduler 1.1.1</a></p>
<p>Версия Flexo CMS: 0.1.1</p>
<p><img src="/public/images/help_16x16.png" alt="" />&nbsp;<a href="/документация/работа-с-плагинами/установка-плагинов.html">Подробней про установку плагинов</a></p>
<h3>История версий</h3>
<p>1.1.1</p>
<p style="padding-left: 30px;">* Добавлена русскоязычная локализация (месяца, даты)<br />* Сохранение текущего состояния календаря (текущая выбранная дата) в cookies&nbsp;</p>
<p>1.0.0</p>
