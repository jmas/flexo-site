...
<html>
	<head>
		...
		<title>Список тэгов | Flexo CMS — open-souce GPL v3 система управления сайтом на PHP с БД MySQL или SQLite. Простая, расширяемая, небольшой размер. Система управления для сайта-визитки, портфолио, корпоративного сайта.</title>
...
<!--	<li><a href="http://code.google.com/p/flexo-manage-content/downloads/list">Скачать</a> <small>0.1.4RC</small></li> -->
			...
			<div id="middler">
				<aside id="sidebar">
										...
										<nav id="submenu">
						<ul>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/pages-of-tag.html" >Страницы для тега</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/tags.html"  class="current">Список тэгов</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/карта-с-главной.html" >Карта с главной</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/выборка-из-двух-разделов.html" >Выборка из двух разделов</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/дерево-страниц.html" >Дерево страниц</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/простое-меню.html" >Простое меню</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/галерея.html" >Галерея</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/получение-твитов.html" >Вывод последних твитов</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/вывод-подстраниц-по-месяцам.html" >Вывод подстраниц по месяцам</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/лента-с-постраничной-навигацией.html" >Лента с постраничной навигацией</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/таблица-подстраниц.html" >Таблица подстраниц</a>															</li>
														<li><a href="http://flexo.up.dn.ua/тестовый-полигон/форма-обратной-связи.html" >Форма обратной связи</a>															</li>
													</ul>
					</nav>
										
					<p style="background: #fff; padding: 1em 1.5em; font-size: 80%; border-radius: 15px; -webkit-border-radius: 15px; -moz-border-radius: 15px;">Здесь проходят учения, поэтому все может рушиться и ломаться&hellip;</p>					
...
<a href="http://flexo.up.dn.ua/тестовый-полигон.html" title="Тестовый полигон">Тестовый полигон</a> <span class="breadcrumb-separator"> &rarr; </span> 
<span class="breadcrumb-current">Список тэгов</span></div>
					
					<h1>Список тэгов</h1>
					
					
<ul class="tags-list">
		<li><a href="/тестовый-полигон/pages-of-tag?name=tags">tags</a> (1)</li>
		<li><a href="/тестовый-полигон/pages-of-tag?name=page">page</a> (1)</li>
		<li><a href="/тестовый-полигон/pages-of-tag?name=snippet">snippet</a> (1)</li>
	</ul>					
									</div><!--/#content-->
			</div><!--/#middler-->
