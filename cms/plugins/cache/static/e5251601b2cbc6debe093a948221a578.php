...
<html>
	<head>
		...
		<title>Cache | Flexo CMS — open-souce GPL v3 система управления сайтом на PHP с БД MySQL или SQLite. Простая, расширяемая, небольшой размер. Система управления для сайта-визитки, портфолио, корпоративного сайта.</title>
				...
				<aside id="sidebar">
						...
						<ul>
														<li><a href="http://flexo.up.dn.ua/расширения/плагины.html"  class="current">Плагины</a>																<ul>
																		...
																		<li><a href="http://flexo.up.dn.ua/расширения/плагины/cache.html"  class="current">Cache</a></li>
...
<span class="breadcrumb-current">Cache</span></div>
					
					<h1>Cache</h1>
					
					<p>Плагин позволяет кэшировать выбранные страницы сайта.</p>
<p>После активации плагина при редактировании страницы можно оставить включенной галочку напротив опции &laquo;Кэшировать эту страницу&raquo;, тем самыи включить кэширование конкретной страницы.</p>
<p><em>Вы должны помнить</em>, что некоторые страницы всегда должны быть динамическими, например, страница с формой обратной связи. Для таких страниц необходимо отключать опцию кэширования.</p>
<p>Скачать плагин: <img style="vertical-align: middle;" src="/public/images/file-zip.png" alt="" />&nbsp;<a href="/public/files/plugins/cache-1.0.2.zip">Cache 1.0.2</a></p>
<h2>История версий</h2>
<p>1.0.2</p>
<p style="padding-left: 30px;">Исправлено кэширование для страниц/подстраниц с типом Archive.</p>
<p>1.0.0</p>
