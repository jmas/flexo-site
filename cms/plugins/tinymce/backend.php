...
function tinymce_layout_backend_head_handler()
{
	...
	$buttons_sets_panel1 = split(',', $ini['panel_buttons1']);
	$buttons_sets_panel2 = split(',', $ini['panel_buttons2']);
	$buttons_sets_panel3 = split(',', $ini['panel_buttons3']);
	$buttons_sets_panel4 = split(',', $ini['panel_buttons4']);
