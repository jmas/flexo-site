...
class TinymceController extends PluginController
{
	...
	public function settings()
	{
		...
		$buttons_sets = array(
			!empty($buttons_sets_panel1) ? split(',', $buttons_sets_panel1): array(),
			!empty($buttons_sets_panel2) ? split(',', $buttons_sets_panel2): array(),
			!empty($buttons_sets_panel3) ? split(',', $buttons_sets_panel3): array(),
			!empty($buttons_sets_panel4) ? split(',', $buttons_sets_panel4): array()
		);
